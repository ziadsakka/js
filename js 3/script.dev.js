...
function displayBookmark() {
  ...
  for (var i = 0; i < bookmarks.length; i++) {
    newBookmark += "\n            <tr>\n                <td>".concat(i + 1, "</td>\n                <td>").concat(bookmarks[i].name, "</td>              \n                <td><button onclick=\"openPage(").concat(i, ")\" class=\"btn btn-success\"><i class=\"fa-solid fa-eye pe-2\"></i>Visit</button></td>\n                <td><button onclick=\"deleteItem(").concat(i, ")\" class=\"btn btn-danger\"><i class=\"fa-solid fa-trash pe-2\"></i>Delete</button></td>\n            </tr>");
